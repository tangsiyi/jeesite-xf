...
<body>
	...
	<form:form id="inputForm" modelAttribute="site" action="${ctx}/cms/site/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label" for="title">站点标题:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label" for="theme">默认主题:</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label" for="customIndexView">自定义首页视图:</label>
			<div class="controls">
